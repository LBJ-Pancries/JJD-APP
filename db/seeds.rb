...
Category.create(name: "A1", description: "54平米，2、3、5、6#楼一层，共8户")
Category.create(name: "A2", description: "51平米，2、3、5#楼二层，共6户")
Category.create(name: "A3", description: "40平米，2、3、5#楼三层，共6户")
Category.create(name: "C1", description: "87平米，6#楼二层，共2户")
Category.create(name: "B1", description: "50平米，1、4#楼一层，共4户")
Category.create(name: "B2", description: "52平米，1、4#楼二层，共8户")
Category.create(name: "B3", description: "82平米，1、4#楼三层，共4户")
puts "户型创建完"
...
puts "1#楼创建完"
House.create(title: "4#101", description: "单眼灶", category_id: "5")
